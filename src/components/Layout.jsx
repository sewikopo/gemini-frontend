...
import { MenuUnfoldOutlined, MenuFoldOutlined, HomeOutlined, UserSwitchOutlined, MoneyCollectOutlined, LogoutOutlined, ShoppingCartOutlined, ReconciliationOutlined } from "@ant-design/icons";
import "./layout.css";
  ...
  return (
    <Layout>
      ...
      <Sider trigger={null} collapsible collapsed={collapsed}>
        <div className="logo">
          <h2 className="logo-title">GM POS</h2>
        </div>
